...
import TshirtBuilder from "pages/TshirtBuilder/TshirtBuilder";
        ...
        <Switch>
          ...
          {!auth.isEmpty && auth.isLoaded && (
            <Switch>
              ...
              <Route exact path="/tshirt-builder" component={TshirtBuilder} />
              {admin && <Route path="/admin" component={Admin} />}
              {isVip && (
                <Route
                  exact
                  path="/account/vip/"
                  component={TippiVipDashboard}
                />
              )}
              {isVip && (
                <Route
                  exact
                  path="/account/vip/my-products"
                  component={TippiVipDashboard}
                />
              )}
              {isVip && (
                <Route
                  exact
                  path="/account/vip/profiles"
                  component={TippiMyProfile}
                />
              )}
              {isVip && (
                <Route
                  exact
                  path="/account/vip/profiles/manage"
                  component={TippiManageProfile}
                />
              )}
              {isVip && (
                <Route
                  path="/account/vip/profiles/manage/:profile"
                  component={TippiManageProfile}
                />
              )}
              {!match.isExact && (
